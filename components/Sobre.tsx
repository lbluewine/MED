...
import { PRECISA_DE_CONTA, relatoDeErro } from "@/lib/relato";
...
export default function Sobre({ municipioId }: { municipioId?: string }) {
  return (
    <Pagina municipioId={municipioId} atual="sobre">
        ...
        <p className="mt-3 max-w-[65ch]">
          Uma vez por semana um robô confere se esses documentos mudaram.{" "}
          <a
            className="underline"
            href={municipioId ? `/${municipioId}/fontes` : "/fontes"}
          >
            O estado de cada fonte fica aberto nesta página
          </a>
          , inclusive quando a conferência falha.
        </p>
        <p className="mt-3 max-w-[65ch]">
        ...
        <p className="mt-3 max-w-[65ch]">
          ...
          diga em que página estava e o que está errado, e a gente confere na
          fonte.
        </p>
        <p className="mt-3 max-w-[65ch]">
          <a
