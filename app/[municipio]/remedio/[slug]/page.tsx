...
import type { Componente, ItemRemume } from "@/lib/schema";
...
export default async function PaginaRemedio({
  ...
  // Nulo é resposta: a lista de alguns municípios não diz o componente. Sem
  // ele, a frase de "quem entrega" não é escrita — o que a pessoa precisa,
  // que é onde retirar, continua vindo de `onde_retirar`.
  const componentes = [
    ...new Set(
